...
flags.DEFINE_string("in_dir", None, "Input directory with WAV files")
flags.DEFINE_integer("maxdepth",3,"Maximum depth of subdirectories")
FLAGS = flags.FLAGS
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        ...
        root_folder = os.path.basename(os.path.dirname(os.path.join(FLAGS.in_dir, '')))
        ...
        for fld in tqdm(folders):
            ...
            for fle in files:
                ...
                if fm != 16000:
                    ...
                    number_of_samples = int(round(len(wav_data) * float(16000) / fm))
                ...
                save_path = os.path.join(FLAGS.save_clean_path,
